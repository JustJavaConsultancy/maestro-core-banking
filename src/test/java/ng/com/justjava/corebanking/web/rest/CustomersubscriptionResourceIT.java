...
import ng.com.justjava.corebanking.repository.CustomersubscriptionRepository;
import ng.com.justjava.corebanking.service.CustomersubscriptionService;
import ng.com.justjava.corebanking.service.dto.CustomersubscriptionDTO;
import ng.com.justjava.corebanking.service.mapper.CustomersubscriptionMapper;
...
public class CustomersubscriptionResourceIT {
    ...
    public void createCustomersubscription() throws Exception {
        ...
        Assertions.assertThat(testCustomersubscription.getFrequency()).isEqualTo(DEFAULT_FREQUENCY);
    }
    ...
    public void updateCustomersubscription() throws Exception {
        ...
        Assertions.assertThat(testCustomersubscription.getFrequency()).isEqualTo(UPDATED_FREQUENCY);
    }
