...
public class PaymentTransactionResourceIT {
    ...
    public void createPaymentTransaction() throws Exception {
        ...
        Assertions.assertThat(testPaymentTransaction.getTransactionType()).isEqualTo(DEFAULT_TRANSACTION_TYPE);
    ...
    public void updatePaymentTransaction() throws Exception {
        ...
        Assertions.assertThat(testPaymentTransaction.getTransactionType()).isEqualTo(UPDATED_TRANSACTION_TYPE);
