...
export const EntitiesMenu = props => (
  ...
  >
    ...
    <MenuItem icon="asterisk" to="/approval-group">
      <Translate contentKey="global.menu.entities.approvalGroup"/>
    </MenuItem>
    <MenuItem icon="asterisk" to="/approval-workflow">
      <Translate contentKey="global.menu.entities.approvalWorkflow"/>
    </MenuItem>
    <MenuItem icon="asterisk" to="/super-agent">
      <Translate contentKey="global.menu.entities.superAgent"/>
    </MenuItem>
