"use strict";
const inline = require('./inlinescript');
  ...
  _createClass(RemitaPayment, [{
    ...
    value: function startPayment() {
      var _this$props$remitaDat = this.props.remitaData,
          ...
          transactionId = _this$props$remitaDat.transactionId,
          phoneNumber = _this$props$remitaDat.phoneNumber,
