...
const Routes = ({ match }) => (
  <div>
    <Switch>
      ...
      <ErrorBoundaryRoute path={`${match.url}approval-group`} component={ApprovalGroup} />
      <ErrorBoundaryRoute path={`${match.url}approval-workflow`} component={ApprovalWorkflow} />
