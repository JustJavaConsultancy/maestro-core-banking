...
import ng.com.justjava.corebanking.service.ussd.*;
...
//            PaymentResponseDTO paymentResponseDTO = null;
    ...
    public GenericStpResponse authenticateOTP(@Valid @RequestBody AuthenticateOTPRequest request) throws Exception {
        ...
        if (accountNumber != null && otp != null) {
            ...
            if (walletAccount != null && walletAccount.getAccountOwner() != null) {
                ...
                if (ownerPhoneNumber != null && ownerPhoneNumber.equalsIgnoreCase(mobileNumber)) {
                    ...
                    if (!result) {
                        genericStpResponse.setResponseCode(ExtendedConstants.ResponseCode.INVALID_OTP.getCode());
                        genericStpResponse.setResponseMessage(ExtendedConstants.ResponseCode.INVALID_OTP.getDescription());
        ...
        genericStpResponse.setResponseCode(ExtendedConstants.ResponseCode.CUSTOMER_ACCOUNT_RECORD_MISMATCH.getCode());
        genericStpResponse.setResponseMessage(ExtendedConstants.ResponseCode.CUSTOMER_ACCOUNT_RECORD_MISMATCH.getDescription());
    ...
    public ResponseEntity<GenericResponseDTO> processPaymentNotification(@RequestBody
        ...
        for (RemitaBillerNotification payment : notification) {
            ...
            if (customfielddataList.isEmpty()) {
                return new ResponseEntity<>(new GenericResponseDTO(ExtendedConstants.ResponseCode.SUCCESS.getCode(), "Funding successful", new ArrayList<>()), HttpStatus.OK);
            }
        ...
        return new ResponseEntity<>(new GenericResponseDTO(ExtendedConstants.ResponseCode.FAILED.getCode(), ExtendedConstants.ResponseCode.FAILED.getDescription(), new ArrayList<String>()), HttpStatus.BAD_REQUEST);
    }
    ...
    public ResponseEntity<DefaultApiResponse> getCustomerWallets(@PathVariable String bankCode,
        ...
        if (wallets.isEmpty()) {
            defaultApiResponse.setStatus(ExtendedConstants.ResponseCode.CUSTOMER_ACCOUNT_NOT_FOUND.getCode());
            defaultApiResponse.setMessage(ExtendedConstants.ResponseCode.CUSTOMER_ACCOUNT_NOT_FOUND.getDescription());
        ...
        defaultApiResponse.setStatus(ExtendedConstants.ResponseCode.SUCCESS.getCode());
