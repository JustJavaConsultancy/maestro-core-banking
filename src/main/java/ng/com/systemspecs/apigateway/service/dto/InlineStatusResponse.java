...
public class InlineStatusResponse {
    ...
    public String toString() {
        return "InlineStatusResponse [status=" + status + ", responseCode=" + responseCode + ", responseMsg="
            + responseMsg + ", iResponseCode=" + iResponseCode + ", iResponseMessage=" + iResponseMessage
            + ", appVersionCode=" + appVersionCode + ", responseData=" + responseData + ", data=" + data
