...
public class PurchaseElectricityResponseData {
    ...
    private PurchaseElectricityTokenListResponseData tokenList;
    ...
    @JsonProperty("tokenList")
    public PurchaseElectricityTokenListResponseData getTokenList() {
        return tokenList;
    }

    @JsonProperty("tokenList")
    public void setTokenList(PurchaseElectricityTokenListResponseData tokenList) {
