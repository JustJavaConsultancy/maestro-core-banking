...
import ng.com.systemspecs.apigateway.service.dto.stp.RecieptVO;
import ng.com.systemspecs.apigateway.service.dto.stp.ResponseVm;
import ng.com.systemspecs.apigateway.service.dto.stp.TopPaymentNotificationRequest;
...
public class RemitaPaymentNotifcationResource {
    ...
    public String getRRRStatus(String rrrNumber) {
        ...
        ng.com.systemspecs.apigateway.service.dto.stp.GetRRRDetailsResponse rrrDetailsResponse = null;
        ...
        try {
            ...
            rrrDetailsResponse = new Gson().fromJson(responseBody, ng.com.systemspecs.apigateway.service.dto.stp.GetRRRDetailsResponse.class);
