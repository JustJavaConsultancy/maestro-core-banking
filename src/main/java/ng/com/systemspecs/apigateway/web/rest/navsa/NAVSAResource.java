package ng.com.systemspecs.apigateway.web.rest.navsa;
...
import ng.com.systemspecs.apigateway.web.rest.remitastp.TransactionController;
...
import static ng.com.systemspecs.apigateway.service.dto.stp.ExtendedConstants.ResponseCode.CUSTOMER_ACCOUNT_NOT_FOUND;
import static ng.com.systemspecs.apigateway.service.dto.stp.ExtendedConstants.ResponseCode.SUCCESS;
...
public class NAVSAResource {
    ...
    public ResponseEntity<GenericNavsaResponse> getAccountName(
        ...
        if (walletAccount != null) {
            ...
            genericNavsaResponse.setRespoincecode(SUCCESS.getCode());
    ...
    public ResponseEntity<GenericNavsaResponse> getAccountBalance(@PathVariable String bankCode,
        ...
        if (walletAccount != null) {
            ...
            response.setRespoincecode(SUCCESS.getCode());
    ...
    public ResponseEntity<GenericNavsaResponse> getVirtualAccountDetails(@PathVariable String bankCode,
        ...
        if (walletAccount == null) {
            response.setRespoincecode(CUSTOMER_ACCOUNT_NOT_FOUND.getCode());
            response.setResponseMsg(CUSTOMER_ACCOUNT_NOT_FOUND.getDescription());
            return new ResponseEntity<>(response, HttpStatus.BAD_REQUEST);
        }
