...
import ng.com.systemspecs.apigateway.service.dto.stp.AccountDto;
import ng.com.systemspecs.apigateway.service.dto.stp.DefaultApiResponse;
import ng.com.systemspecs.apigateway.service.dto.stp.OpenAccountResponseDto;
import ng.com.systemspecs.apigateway.service.fcm.PushNotificationService;
import ng.com.systemspecs.apigateway.service.impl.WalletAccountServiceImpl;
import ng.com.systemspecs.apigateway.service.mapper.WalletAccountMapper;
import ng.com.systemspecs.apigateway.util.RemitaCarmelUtils;
...
//                profileDTO.getUser().getLastName().equalsIgnoreCase(String.valueOf(data.get("lastName")))) {
    ...
    public ResponseEntity<DefaultApiResponse> createWalletExternal(@Valid @RequestBody AccountDto accountDto,
                                                                   HttpSession session) {
