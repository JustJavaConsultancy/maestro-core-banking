...
import ng.com.systemspecs.apigateway.client.ExternalEmailRESTClient;
...
import static ng.com.systemspecs.apigateway.service.dto.stp.ExtendedConstants.ResponseCode.IN_SUFFICIENT_FUNDS;
        ...
        if (sourceAccount != null) {
            ...
            if (sourceAccountOwner != null) {
                ...
                if (totalBonus < bonusAmount && bonusAmount > 0) {
                    ...
                    return new GenericResponseDTO(IN_SUFFICIENT_FUNDS.getCode(), HttpStatus.BAD_REQUEST,
            ...
            if (Double.parseDouble(sourceAccount.getActualBalance()) < amount + charges + vatFee) {
                return new GenericResponseDTO(IN_SUFFICIENT_FUNDS.getCode(), HttpStatus.BAD_REQUEST,
                    IN_SUFFICIENT_FUNDS.getDescription(), sourceAccount.getActualBalance());
            }
